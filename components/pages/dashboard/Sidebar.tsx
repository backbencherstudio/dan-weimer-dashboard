...
export const NAV_ITEMS = [
  ...
  { label: "Live Operations", href: "/live-operations", icon: SidebarIcons.Live },
  { label: "Orders management", href: "/orders", icon: SidebarIcons.Order },
  { label: "Contractors management", href: "/contractors", icon: SidebarIcons.Contractors },
  { label: "Runners management", href: "/runners", icon: SidebarIcons.Runners },
  { label: "SupplyHouse management", href: "/supplyhouse", icon: SidebarIcons.SupplyHouse },
  { label: "Payments & Finance", href: "/payments", icon: SidebarIcons.Payment },
];
...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={[
          "fixed z-50 flex h-full w-[272px] shrink-0 flex-col border-r border-slate-100 bg-white transition-transform duration-300 ease-in-out md:relative md:z-auto",
        ...
        <div className="flex items-center justify-between px-5 pb-5 pt-6">
          <div className="flex items-center gap-3">
            <div className="flex h-[42px] w-[49px] shrink-0 items-center justify-center overflow-hidden">
              <Image src="/dan-logo.png" alt="Parts Runner Logo" width={49} height={42} />
            </div>
        ...
        <nav className="flex-1 space-y-3 overflow-y-auto px-3">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                {/* {isActive && (
                  <span className="absolute left-0 top-1/2 h-6 w-1 -translate-y-1/2 rounded-r-full bg-orange-300" />
                )} */}
                ...
                <span
                  className={[
                    ...
                    isActive
                      ? ""
                      : "text-[#070707] group-hover:bg-orange-50 group-hover:text-orange-500",
                  ].join(" ")}
                >
                   <Icon className="text-[" size={20} fill={isActive ? "white" : "none"} />
                </span>
